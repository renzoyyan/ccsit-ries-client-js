...
const EditExtensionServicePage = () => {
    ...
    <AdminLayout>
      ...
      >
        <div className="flex items-center justify-end mt-10 sm:mt-0 gap-x-10">
          <Link href={`/admin/extension-services/${extension_id}`}>
            <a className="inline-block text-sm font-medium text-gray-500 hover:underline">
              Back
            </a>
          </Link>
          <Button
...
export default EditExtensionServicePage;
