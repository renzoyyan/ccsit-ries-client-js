...
import { proposal_format_opts, research_agenda_opts } from "@/utils/utils";
    ...
    <AdminLayout>
      <SectionHeader className="items-center justify-between mt-16 mb-8 sm:flex sm:mb-20">
        <h2 className="text-2xl font-bold">
          Edit{" "}
          <span className="text-bc-primary">Lorem ipsum lorem lorem lorem</span>
        </h2>
      ...
      <FormContainer>
        ...
        <FormProvider {...methods}>
          <form>
            ...
            <div className="grid items-end mt-12 md:grid-cols-2 xl:grid-cols-3 gap-x-6 gap-y-8">
              <Form.Group>
                <Form.Select
                  options={proposal_format_opts}
                  name="research_proposal_format"
