    ...
    <Table.Container>
      <Table.Head>
        <Table.Row>
          ...
          <Table.Header
            className="w-1/4 pr-48 sm:pl-6 tbl-header"
            title="Research Title"
          />
          <Table.Header className="w-1/6 tbl-header" title="Proponent(s)" />
          <Table.Header className="w-1/6 tbl-header" title="Research Agenda" />
          <Table.Header className="w-1/6 tbl-header" title="Duration" />
