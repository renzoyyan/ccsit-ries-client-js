    ...
    <Popover className="relative">
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute right-0 translate-x-[60px] z-10 max-w-sm px-4 mt-3 sm:transform  sm:translate-x-[5%] 2xl:translate-x-[10%] w-screen sm:px-0 lg:max-w-lg h-[516px] overflow-y-auto rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 scrollbar-thumb-rounded">
              <div
