...
const Modal = ({ modalTitle = "", isOpen, toggleModal, children }) => {
  return (
    <>
        ...
        <Dialog as="div" className="relative z-10" static onClose={() => null}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex items-center justify-center min-h-full p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl p-5 overflow-hidden text-left align-middle transition-all transform bg-white rounded-md shadow-xl">
                  <Dialog.Title
                    as="h3"
